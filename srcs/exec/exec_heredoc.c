...
/*   Updated: 2024/11/03 17:08:42 by mmiilpal         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static bool ft_heredoc_signal(int *fd, int *pid, t_data *data)
{
	waitpid(*pid, pid, 0);
